...
#
# PURPOSE:
#       Interpolate a given input netCDF file to the UM N144 grid (288x217),
#       using either bilinear or area-weighted interpolation.
#
# CALLING SEQUENCE:
#       interpolate_to_n144.tcl -i inputfile -o outputfile -f fieldnum -[abm] -x tempfile
#
...
if {$location >= 0} {
    puts " "
    puts "Interpolate to N144 (Convsh script) Version $version.  Written by Nicholas Klingaman."
    puts " "
...
if {$extrapolate} {
    ...
    puts "$argv0 : extrapolate over missing data before interpolating to N144."
...
# Interpolate data from 3241x2441 regular grid to UM 288x193 grid
